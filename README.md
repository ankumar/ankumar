...
Currently Platform engineering @ Acuity Brands | http://Walmart.com (Largest Enterprise, >2M Workforce) | Co-founded TenHands (Startup) | Yahoo! (pioneer of the early Internet) | Sylantro Systems (Startup) | Bell Labs (Large Enterprise, Part of AT&T >1M employees)

**Industrial IoT:** Incubating [Backstage open source](https://backstage.io/) based Developer experience integrated with Dev, Compute & Data Cloud Infrastructure for Intelligent Lighting & Controls

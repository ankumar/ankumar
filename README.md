...
- ML Development - https://app.chaya.ai/ (Private, Open Source soon!)
...
* My ‘Software is Eating the World’ started with [Switching software](https://freeswitch.org/confluence/display/FREESWITCH/Glossary#Glossary-Softswitch), IP protocols development (OverLAN project / X.25 -> TCP/IP -> VoIP)
